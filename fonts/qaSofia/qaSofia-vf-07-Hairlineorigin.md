...
* 🔥 **FAIL** TYPOGRAPHIC_SUBFAMILY_NAME entry for Win "Hairline" must be "Regular". Please note, since the font style is RIBBI, this record can be safely deleted. [code: bad-win-name]
